...
public class ImportPlayerDTO {
    ...
    //тук е localDate, но задаваме типа да е String за да може по лесно да се справим с обработката.
    //кoгато сложим да е от тип String, използваме modelMapper-а за да го парснем
